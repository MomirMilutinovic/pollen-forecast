...
tr_control <- trainControl(method = "timeslice", initialWindow = 415, horizon = 30, skip = 30)

set.seed(8)
fit.xgbDART <- train(next_day ~ ., data=train, method='xgbDART', trControl = tr_control, metric = 'RMSE', preProcess=c("center","scale"))
