...
set.seed(8)
baseline.lm <- trainModel(mydata, 'lm')
baseline.lm
```

```{r}
set.seed(8)
baseline.glmboost <- trainModel(mydata, 'glmboost')
...
```{r}
set.seed(8)
baseline.treebag <- trainModel(mydata, 'treebag')
...
```{r}
set.seed(8)
delta.glmboost <- trainModel(mydata, 'glmboost')
...
```{r}
set.seed(8)
delta.treebag <- trainModel(mydata, 'treebag')
...
```{r}
set.seed(8)
encodedDay.lm <- trainModel(mydata, 'lm')
...
```{r}
set.seed(8)
encodedDay.glmboost <- trainModel(mydata, 'glmboost')
...
```{r}
set.seed(8)
encodedDay.treebag <- trainModel(mydata, 'treebag')
...
encodedDay.bagEarth <- trainModel(mydata, 'bagEarth')
encodedDay.bagEarth
```

```{r}
set.seed(8)
encodedDay.bagEarthGCV<- trainModel(mydata, 'bagEarthGCV')

encodedDay.bagEarthGCV
```

```{r}
set.seed(8)
encodedDay.bartMachine <- trainModel(mydata, 'bartMachine')

encodedDay.bartMachine
```

```{r}
set.seed(8)
encodedDay.bayesglm <- trainModel(mydata, 'bayesglm')
...
```{r}
set.seed(8)
encodedDay.brnn <- trainModel(mydata, 'brnn')
...
```{r}
set.seed(8)
encodedDay.xgbTree <-trainModel(mydata, 'xgbTree')
...
```{r}
set.seed(8)
encodedDay.M5 <- trainModel(mydata, 'M5')
...
```{r}
set.seed(8)
encodedDay.svmLinear <- trainModel(mydata, 'svmLinear')

encodedDay.svmLinear
```
